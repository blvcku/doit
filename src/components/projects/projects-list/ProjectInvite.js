import DefaultImage from '../../../images/default-project.jpg';
...
const ProjectInvite = ({title, id, index, photoURL, projectInvites, setProjectInvites}) => {
    ...
    return(
        <ProjectInviteContainer loading={loading} background={photoURL || DefaultImage}>
            <div>
                <p>{title}</p>
                <div>
                    <button onClick={handleDeclineInvite} type='button'>Decline</button>
                    <button onClick={handleAcceptInvite} type='button'>Accept</button>
                </div>
            </div>
