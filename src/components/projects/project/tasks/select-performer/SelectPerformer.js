...
import { MemberContainer, MemberButton } from "../../members-list/Members.styles";
    ...
    return(
        <Container>
            <CloseButton onClick={handleCloseSelecting} type='button'>
                <img src={CloseIcon} alt='close the menu with option of choosing the performer of the task' />
            </CloseButton>
