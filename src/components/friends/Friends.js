...
import { Container, Wrapper, Nav, Section, CustomNavLink } from "./Friends.styles";
            ...
            <Wrapper>
                <header>
                    <Nav>
                        ...
                        <CustomNavLink onClick={clearSearchTerm} activeClassName="active" to={`${path}/search`}>
                        ...
                        <CustomNavLink onClick={clearSearchTerm} activeClassName="active" to={`${path}/list`}>
                ...
                <Section>
                    <Switch>
                        ...
                        <Route path={`${path}/search`} render={() => <SearchFriends searchTerm={searchTerm} />} />
