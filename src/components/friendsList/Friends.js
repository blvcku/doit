        ...
        <Container>
            <Wrapper>
                <Nav>
                    ...
                    <NavLink activeClassName="activeFriends" to={`${path}/search`}>
                    ...
                    <NavLink activeClassName="activeFriends" to={`${path}/list`}>
                ...
                <Section>
                    <Switch>
                        ...
                        <Route path={`${path}/list`} component={FriendsList} />
                        <Route path={`${path}/search`} component={SearchList} />
