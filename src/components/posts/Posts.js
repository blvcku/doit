...
const Posts = () => {
    ...
    return(
        <Container>
            <SubContainer>
                <Nav>
                    <CustomNavLink to={`${path}/global`} activeClassName='activePosts'>
                    ...
                    <CustomNavLink to={`${path}/myposts`} activeClassName='activePosts'>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 31.147 31.147">
                    ...
                    <CustomNavLink to={`${path}/create`} activeClassName='activePosts'>
