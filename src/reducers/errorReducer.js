const errorReducer = (state, action) => {
    switch (action.type) {
        ...
        case "auth/resetpassword-failed":
            return (state = {
                error: "The account with the given email address does not exist.",
            });
        ...
        case "auth/username-too-short":
            return (state = {
                error: "Your username is too short. Minimum 6 characters.",
            });
        case "auth/failed-to-log-out":
            return (state = {
                error: "Failed to log out. Relogin or try again later.",
            });
        case "auth/requires-recent-login":
            return (state = {
                error: "Log in again to change profile settings.",
            });
        case "auth/failed-to-send-mail":
            return (state = {
                error: "Failed to send verification mail. Relogin or try again later.",
            });
        case "update/wrong-image-type":
            return (state = {
                error: "Unaccepted file type. JPEG or PNG only.",
            });
        case "update/change-image-failed":
            return (state = {
                error: "Failed to change your profile picture. Relogin or try again later.",
            });
        case "projects/create":
            return (state = {
                error: "Failed to create project. Relogin or try again later.",
            });
        case "projects/edit":
            return (state = {
                error: "Failed to edit your project. Relogin or try again later.",
            });
        case "projects/delete":
            return (state = {
                error: "Failed to delete your project. Relogin or try again later.",
            });
        case "projects/leave":
            return (state = {
                error: "Failed to leave project. Relogin or try again later.",
            });
        ...
        case "projects/change-image-failed":
            return (state = {
                error: "Failed to change project image. Relogin or try again later.",
            });
        case "projects/task-delete":
            return (state = {
                error: "Failed to delete task. Relogin or try again later.",
            });
        ...
        case "projects/task-update":
            return (state = {
                error: "Failed to edit task. Relogin or try again later.",
            });
        case "projects/task-create":
            return (state = {
                error: "Failed to create task. Relogin or try again later.",
            });
        case "projects/task-status":
            return (state = {
                error: "Failed to change task status. Relogin or try again later.",
            });
        case "projects/task-file":
            return (state = {
                error: "Failed to upload file. Relogin or try again later.",
            });
        case "projects/accept-invite":
            return (state = {
                error: "Failed to accept project invitation. Relogin or try again later.",
            });
        case "projects/decline-invite":
            return (state = {
                error: "Failed to decline project invitation. Relogin or try again later.",
            });
        case "projects/delete-member":
            return (state = {
                error: "Failed to delete member. Relogin or try again later.",
            });
        case "projects/delete-invite":
            return (state = {
                error: "Failed to cancel project invitation. Relogin or try again later.",
            });
        case "projects/invite":
            return (state = {
                error: "Failed to send project invitation. Relogin or try again later.",
            });
        ...
        case "projects/step-failed":
            return (state = {
                error: "Failed to change step status. Relogin or try again later.",
            });
        case "projects/failed-send-message":
            return (state = {
                error: "Failed to send message. Relogin or try again later.",
            });
        case "projects/message-wrong-file-type":
            return (state = { error: "Unaccepted file type." });
        case "friends/delete":
            return (state = {
                error: "Failed to delete user from friend list. Relogin or try again later.",
            });
        case "friends/request":
            return (state = {
                error: "Failed to send friend request. Relogin or try again later.",
            });
        case "friends/request-delete":
            return (state = {
                error: "Failed to delete friend request. Relogin or try again later.",
            });
        case "friends/invite-decline":
            return (state = {
                error: "Failed to decline friend request. Relogin or try again later.",
            });
        case "friends/accept":
            return (state = {
                error: "Failed to accept friend request. Relogin or try again later.",
            });
        ...
        case "forms/no-answers":
            return (state = {
                error: "Question has no answers. Add one to create form.",
            });
        ...
        case "forms/failed-to-create":
            return (state = {
                error: "Failed to create form. Relogin or try again later.",
            });
        case "forms/answer-every-question":
            return (state = { error: "Answer every question to submit form." });
        case "forms/failed-to-submit":
            return (state = {
                error: "Failed to submit form. Relogin or try again later.",
            });
        case "forms/failed-to-pause":
            return (state = {
                error: "Failed to pause/unpause form. Relogin or try again later.",
            });
        case "forms/failed-to-delete":
            return (state = {
                error: "Failed to delete form. Relogin or try again later.",
            });
        case "posts/wrong-file-type":
            return (state = { error: "Unaccepted file type." });
        case "posts/failed-to-create":
            return (state = {
                error: "Failed to create post. Relogin or try again later.",
            });
        ...
        case "posts/failed-to-delete":
            return (state = {
                error: "Failed to delete post. Relogin or try again later.",
            });
        case "posts/failed-to-edit":
            return (state = {
                error: "Failed to edit post. Relogin or try again later.",
            });
        ...
        case "canvas/create":
            return (state = {
                error: "Failed to create canvas. Relogin or try again later.",
            });
        case "canvas/delete":
            return (state = {
                error: "Failed to delete your canvas. Relogin or try again later.",
            });
        default:
            return (state = {
                error: "Something went wrong. Relogin or try again later.",
            });
    }
};
